...
class Client:
    ...
    print (f'Endereço: {addr} Porta: {port}') #após receber o endereço e porta ele imprime apenas para o conhecimento
    if addr and port:
       conn = rpyc.connect(addr, port) #Usa o endereço IP e porta recebidos para se conectar ao servidor de aplicação
